( function( $ ) {
    ...
    $(window).load(function(){
        ...
        $('#diamond-donator-control-items').append("<p>Don't forget to fill out the meta for the image sources (Title goes to name, description goes to description, Alt goes to alt) </p>");
        ...
        $("#add-diamond").click(function(){
            ...
            custom_uploader.on('select', function() {
                ...
                selection.map( function( attachment ) {
                    ...
                    $("#diamond-donator-id-" + i.toString()).append( "<a id='delete-diamond-donator-btn' class='button-secondary'>Delete Sponsor</a>" );
                    diamond_donators_info.push({'donator_name': attachment.title, 'donator_desc':attachment.description, 'donator_image': attachment.url});
                    //
                });
        ...
        $(document).on('click', '#delete-diamond-donator-btn', function () {
            var diamond_donator_image = $('img', this.parent).attr('src');
            diamond_donators_info = diamond_donators_info.filter(function (diamond_donators, index, arr) {
                return diamond_donators.donator_image != diamond_donator_image;
            });
